  ...
  return (
    <footer className="bg-gray-900 text-gray-300 mt-12">
      <div className="container mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-6">
        <div>
          ...
          <p className="mt-2 text-sm">
            A simple platform for renting homes and shops. Built for student projects and demos.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="mt-2 space-y-1 text-sm">
            ...
            <li><Link className="hover:underline" to="/create">Create Listing</Link></li>
            <li><a className="hover:underline" href="mailto:info@tolet.example">Contact</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="mt-2 text-sm">
            Email: <a className="text-indigo-400 hover:underline" href="mailto:info@tolet.example">info@tolet.example</a>
          </p>
      ...
      <div className="border-t border-gray-800 py-4">
        <div className="container mx-auto px-4 text-center text-sm text-gray-500">&copy; {new Date().getFullYear()} Tolet. All rights reserved.</div>
      </div>
    </footer>
  )
}
